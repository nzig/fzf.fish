...
function fzf_configure_bindings --description "Installs the default key bindings for fzf.fish with user overrides passed as options."
    ...
    if test $status -ne 0
        ...
        # index 1 = directory, 2 = git_log, 3 = git_status, 4 = history, 5 = variables, 6 = processes, 7 = magic
        set key_sequences \e\cf \e\cl \e\cs \cr \cv \e\cp \em # \c = control, \e = escape
        ...
        set --query _flag_magic && set key_sequences[7] "$_flag_magic"
        ...
        for mode in default insert
            ...
            test -n $key_sequences[7] && bind --mode $mode $key_sequences[7] _fzf_magic_mode
        end
